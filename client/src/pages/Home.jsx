...
export default function Home({ onRegisterClick }) {
    return (
        <div className="bg-gradient-to-b from-[#0f0f0f] via-[#1a1a1a] to-[#101a17]">
                ...
                <div className="flex flex-col-reverse lg:flex-row items-center justify-between w-full max-w-7xl gap-16">
                    ...
                    <div className="lg:w-1/2 text-center sm:text-left space-y-6">
                        ...
                        <div className="flex items-center justify-center sm:justify-start gap-3 flex-wrap">
                            <h2 className="text-lg sm:text-xl text-[#00C896] font-semibold tracking-wide uppercase">Track</h2>
                            <span className="text-white text-xl">⟶</span>
                            <h2 className="text-lg sm:text-xl text-[#00C896] font-semibold tracking-wide uppercase">Connect</h2>
                            <span className="text-white text-xl">⟶</span>
                            <h2 className="text-lg sm:text-xl text-[#00C896] font-semibold tracking-wide uppercase">Recover</h2>
                        </div>

                        <p className="text-base sm:text-lg text-gray-300 leading-relaxed">
                            Your complete companion for post-surgery recovery. Track your progress effortlessly, communicate seamlessly with your doctor, and gain peace of mind every step of the way. We're here to help you get back to your best, faster and more confidently.
                        </p>
                        ...
                        <div className="pt-6 grid grid-cols-2 md:grid-cols-3 gap-6 text-white text-center">
                            ...
                            <div className="col-span-2 md:col-span-1 md:col-start-auto mx-auto">
                                ...
                                <p className="text-sm text-gray-400 mt-1">Surgeries Monitored</p>
                            </div>
                        </div>
                    ...
                    <div className="lg:w-1/2 flex justify-center">
                        <img src={heroImg} alt="Hero Illustration" className="w-full max-w-xs sm:max-w-md lg:max-w-full" />
                    </div>
                </div>
            </section>

            {/* Features Section */}
            <section className="max-w-[90%] md:max-w-[80%] mx-auto rounded-[20px] border-2 border-[#00C896] bg-gradient-to-b from-[#101a17] via-[#1a1a1a] to-[#0f0f0f] py-24 px-4 sm:px-6 md:px-16 lg:px-24 text-white">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-4xl sm:text-5xl font-bold text-center mb-6">Key Features</h2>
                    ...
                    <div className="grid gap-10 sm:gap-12 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                        {/* Cards */}
                        {[
                            { icon: '🩺', title: 'Doctor-Patient Connect', desc: 'Seamlessly stay in touch with your healthcare providers through real-time messaging and updates.' },
                            { icon: '📊', title: 'Recovery Tracking', desc: 'Monitor symptoms, progress, medications, and healing with smart daily logs and progress charts.' },
                            { icon: '🔔', title: 'Smart Reminders', desc: 'Never miss a checkup, pill, or update with our automated, personalized reminders system.' },
                            { icon: '📁', title: 'Digital Records', desc: 'Securely store and access all your medical records in one place, anytime, anywhere.' },
                            { icon: '🤖', title: 'AI Health Assistant', desc: 'Get personalized advice and recovery insights powered by our intelligent virtual assistant.' },
                            { icon: '🔒', title: 'Privacy First', desc: 'We use top-level encryption and privacy practices to keep your health data secure.' }
                        ].map((card, i) => (
                            <div key={i} className="bg-[#111111] border border-[#00C89633] rounded-2xl p-6 shadow-[0_10px_25px_rgba(0,200,150,0.2)] hover:shadow-[0_20px_50px_rgba(0,200,150,0.4)] transition-transform duration-200 hover:-translate-y-2">
            ...
            {/* FAQ Section */}
            <section className="max-w-6xl mx-auto px-4 sm:px-6 md:px-12 lg:py-[180px] py-24 text-white">
                <h2 className="text-4xl sm:text-5xl font-bold text-center mb-6">Frequently Asked Questions</h2>
                <p className="text-center text-gray-400 max-w-2xl mx-auto mb-12 text-lg">
                    Got questions? We’re here to help you through every step of your recovery journey.
                </p>
                ...
                <div className="space-y-5">
                    {[
                        ...
                        <details key={i} className="group border border-[#00C89633] rounded-xl bg-[#101a17] transition-all duration-300">
                            <summary className="flex justify-between items-center p-4 cursor-pointer list-none">
                                <span className="text-lg font-semibold text-white">{faq.q}</span>
                                <span className="text-[#00C896] text-2xl transition-transform duration-300 group-open:rotate-45">+</span>
                            </summary>
