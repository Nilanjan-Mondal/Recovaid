...
// Middlewares
app.use(cors({
    origin: "https://recovaid.vercel.app",
...
// Middleware to connect to DB on each request (caching inside connectDB)
...
// Routes
app.get('/', (req, res) => {
    return res.json({ message: "Welcome to Recovaid..." });
});
...
module.exports = app; // Needed for Vercel serverless function export
